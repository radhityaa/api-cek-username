pipeline {
    ...
    environment {
        ...
        DEPLOY_DIR = '/var/www/apigame.ayasyatech.com/html' // Ganti dengan direktori deployment Anda
    }
    ...
    stages {
        stage('Checkout Code') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/radhityaa/api-cek-username.git'
            }
        }
