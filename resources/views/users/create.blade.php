                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control @error('name') is-invalid @enderror" type="text" id="name"
                            name="name" value="{{ old('name') }}" placeholder="Rama Adhitya Setiadi" autofocus
                            required />
                        @error('name')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="no_hp" name="no_hp"
                                class="form-control @error('no_hp') is-invalid @enderror" placeholder="8953xxxxxx" required
                                value="{{ old('no_hp') }}" />
                            @error('no_hp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select select2 @error('jenis_kelamin') is-invalid @enderror"
                            ...
                            <option value="laki-laki" {{ old('jenis_kelamin') == 'laki-laki' ? 'selected' : '' }}>Man
                            </option>
                            <option value="perempuan" {{ old('jenis_kelamin') == 'perempuan' ? 'selected' : '' }}>Woman
                            </option>
                        </select>
                        @error('jenis_kelamin')
                            <div class="invalid-feedback">{{ $message }}</div>
