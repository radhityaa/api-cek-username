        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) {
                ...
                if (Gate::allows('update users')) {
                    $actionBtn = '<a href="' . url("users", $row->user->slug) . '/edit" name="edit" data-id="' . $row->user->id . '" class="editRole btn btn-warning btn-sm me-2"><i class="ti ti-pencil"></i></a>';
                }
                if (Gate::allows('delete users')) {
                    $actionBtn .= '<button type="button" name="delete" data-id="' . $row->user->id . '" class="deleteUser btn btn-danger btn-sm"><i class="ti ti-trash"></i></button>';
                }
